...
export const safeLogAuditEventWithServiceRole = async (event: AuditEvent): Promise<void> => {
  try {
    ...
    // Webhook/payment reconciliation should not break on audit insertion failure.
  }
};
